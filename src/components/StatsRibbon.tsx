            ...
            <div className="container mx-auto px-4 md:px-10 lg:px-20">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    {stats.map((stat, index) => (
                        <div key={index} className={`flex flex-col items-center text-center ${index % 2 !== 0 ? 'border-l border-slate-100' : ''} md:border-l-0 ${index !== 0 ? 'md:border-l md:border-slate-100' : ''}`}>
